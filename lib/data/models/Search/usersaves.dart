class usersaves {
  ...
  String? namecolorEn;
  String? itemId;
  String? itemscolorLocationar;
  String? itemscolorLocationen;
  ...
  usersaves({
    ...
    this.namecolorEn,
    this.itemId,
    this.itemscolorLocationar,
    this.itemscolorLocationen,
    this.itemscolorQuantity,
    this.totalsearch,
    this.historysearchDatetime,
  });

  usersaves.fromJson(Map<String, dynamic> json) {
    ...
    itemId = json['item_id'];
    itemscolorLocationar = json['itemscolor_locationar'];
    itemscolorLocationen = json['itemscolor_locationen'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['itemscolor_locationar'] = this.itemscolorLocationar;
    data['itemscolor_locationen'] = this.itemscolorLocationen;
