...
class cheapest extends StatelessWidget {
    ...
    return GetBuilder<SearchControllerimp>(
      builder: (controller) => Expanded(
        child: Handlingdataview(
          ...
          widget: controller.cheapestdata.isEmpty
              ? _buildEmptyState()
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 5),
          Text(
            'There are no cheap products available',
  ...
  Widget _buildProductCard(SearchControllerimp controller, int index) {
    final currentItem = itemsmodelall.fromJson(controller.cheapestdata[index]);
