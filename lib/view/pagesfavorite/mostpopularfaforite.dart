import 'package:ecommerce/data/models/favorite/popularmodelfaforite.dart';
...
class MostPopularFavorite extends StatelessWidget {
  const MostPopularFavorite({super.key});
    ...
    return Center(
      child: GetBuilder<FavoriteControllerImp>(
        builder: (favoriteController) {
          final items = favoriteController.mostPopularItems;
          ...
          return Handlingdataview(
            ...
            widget: GridView.builder(
              ...
              itemBuilder: (context, index) {
                final currentItem = modelpopularfavorite.fromJson(items[index]);
                final imageUrl =
